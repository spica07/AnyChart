...
/** @inheritDoc */
anychart.core.series.Map.prototype.updateFormatContext = function(provider, opt_rowInfo) {
...
anychart.core.series.Map.prototype.createFormatProvider = function(opt_force) {
  if (!this.pointProvider || opt_force)
    this.pointProvider = new anychart.core.FormatContext();
  return this.updateFormatContext(/** @type {!anychart.core.FormatContext} */ (this.pointProvider));
};
